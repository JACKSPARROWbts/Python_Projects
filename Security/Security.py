...
face_cascade=cv2.CascadeClassifier("C:\\Users\\ADMIN\\Music\\Python\\web\\haarcascade_frontalface_default.xml")
...
while cap.isOpened():
    ...
    cv2.imwrite("C:\\Users\\ADMIN\\Music\\Python\\web\\personimg.jpg",gray)
    if cv2.waitKey(1) & 0xFF==ord("q"):
        break 
    
imageofbill=face_recognition.load_image_file('C:\\Users\\ADMIN\\Music\\Python\\web\\personimg.jpg')
billfaceencoding=face_recognition.face_encodings(imageofbill)[0]
unknownimage=face_recognition.load_image_file('C:\\Users\\ADMIN\\Music\\Python\\web\\sparrow.jpg')
...
if results[0]:
    ...
    time.sleep(3)
    fromaddr = "18tucs221@skct.edu.in"
    toaddr = "18tucs221@skct.edu.in"
